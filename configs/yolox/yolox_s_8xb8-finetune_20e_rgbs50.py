...
default_hooks = dict(
    checkpoint=dict(
        interval=interval,
        max_keep_ckpts=20  # only keep latest 20 checkpoints
    ))
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/checkpoints/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'