...
model = dict(
    ...
    bbox_head=dict(num_classes=6, in_channels=256, feat_channels=256))
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/checkpoints/yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'