...
# RGBS50数据集类别定义
metainfo = {
    'classes': ('connected_ball', 'connected_polyhedron', 
                'iron_ball'),
...
train_dataset = dict(
    ...
    data_root=data_root,
    metainfo=metainfo,
    ann_file='instances_train_filtered.json',
...
val_dataset = dict(
    ...
    data_root=data_root,
    metainfo=metainfo,
    ann_file='instances_val_filtered.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'instances_val_filtered.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
