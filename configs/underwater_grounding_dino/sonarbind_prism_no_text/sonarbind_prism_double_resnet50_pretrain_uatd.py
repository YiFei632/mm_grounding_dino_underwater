...
# dataset settings
# UTDAC2020数据集根目录
data_root = '/media/fishyu/fish-14tb-2/YiFei/Dataset/UATD_COCO/'
...
# UTDAC2020数据集类别定义
metainfo = {
    'classes': ('ball', 'circle cage', 'cube', 'cylinder', 'human body', 'metal bucket', 'plane', 'rov', 'square cage', 'tyre'),
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/work_dirs/sonarbind_prism_double_resnet50_pretrain_duo/epoch_12.pth'