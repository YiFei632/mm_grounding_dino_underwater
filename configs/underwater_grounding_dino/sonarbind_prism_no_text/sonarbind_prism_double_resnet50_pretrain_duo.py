...
# dataset settings
# UTDAC2020数据集根目录
data_root = '/media/fishyu/fish-14tb-2/YiFei/Dataset/DUO/'
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/work_dirs/sonarbind_prism_double_resnet50_pretrain_uxo/epoch_12.pth'