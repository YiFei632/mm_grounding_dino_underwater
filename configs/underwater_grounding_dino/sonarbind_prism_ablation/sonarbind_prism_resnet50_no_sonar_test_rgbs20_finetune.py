...
model = dict(
    ...
    fft_band0_filter=dict(                                                                                                                                                                           
        radius_ratio=0.8,  # Band0外半径占最大半径的比例（推荐0.1-0.3）                                                                                                                              
        enabled=True,      # 是否启用滤波（设为False可快速对比实验）                                                                                                                                 
    ),                                                                                                                                                                                               
    # ============================================
    # Contrastive loss configuration for multi-modal alignment
    # ========== 消融实验：禁用声纳对比损失 ==========
    loss_sonar_image_weight=0.0,  # Weight for sonar-image contrastive loss (disabled for ablation)
