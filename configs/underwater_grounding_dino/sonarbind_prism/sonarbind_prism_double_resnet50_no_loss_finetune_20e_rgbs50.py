...
model = dict(
    ...
    loss_sonar_image_weight=0.0,  # Weight for sonar-image contrastive loss
    loss_sonar_text_weight=0.0,   # Weight for sonar-text contrastive loss
    contrastive_temperature=0.00,  # Temperature parameter (CLIP default)
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/work_dirs/sonarbind_prism_double_resnet50_no_loss_pretrain_rgbs50/epoch_12.pth'