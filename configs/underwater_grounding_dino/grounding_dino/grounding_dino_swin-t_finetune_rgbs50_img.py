...
test_pipeline = [
    ...
    dict(
        ...
        num_sample_negative=85,
        max_tokens=256,
        full_sampling_prob=1.0),  # 关键：处理空标注的图像
    dict(
        type='PackDetInputs',
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
...
load_from = '/media/fishyu/fish-14tb-2/YiFei/Grounding_DINO/mmdetection/checkpoints/grounding_dino_swin-t_pretrain_obj365_goldg_grit9m_v3det_20231204_095047-b448804b.pth'